...
if __name__ == "__main__":
    GDSC_ori = "./GDSCv2.resp_1-AUC.Alias.txt"
    ...
    # save to file
    reid_df.to_csv("./GDSCv2.resp_PowellAUC.Alias.txt", header=True, index=True, sep="\t")
    ...
    plt.xlabel('GDSC_AUC', fontsize=20)
    plt.ylabel('adjusted_AUC', fontsize=20)
